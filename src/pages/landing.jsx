  ...
  return (
    <main className="flex flex-col gap-10 sm:gap-20 py-10 sm:py-20">
      ...
      <div className="px-4 sm:px-0">
        <div className="relative overflow-hidden w-full rounded-lg shadow-xl">
          <img 
            src="/banner.jpeg" 
            alt="Hirrd Banner" 
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4 px-4 sm:px-0">
        <Card>
          <CardHeader>
      ...
      <Accordion type="multiple" className="w-full px-4 sm:px-0">
        {faqs.map((faq, index) => (
